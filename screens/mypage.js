          ...
          <View style={styles.body}>
            <View style={styles.profileArea}>
              ...
              <View style={styles.profileText}>
                <Text style={{fontWeight:500, fontSize:18, marginBottom: 5,}}>{user.name}</Text>
                <Text style={{color: '#FF859B', fontSize: 16}}>{user.birthday}</Text>
                <Text style={{color: '#FF859B', fontSize: 16}}>{user.bloodtype}</Text>
              </View>
              {/* 편집 페이지로 이동 */}
              <TouchableOpacity 
                activeOpacity={0.7}
            ...
            <View style={styles.postArea}>
              <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                ...
                <TouchableOpacity onPress={() => 
                  navigation.navigate('Mypage_sent')}>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                ...
                <TouchableOpacity onPress={() => 
                  navigation.navigate('Mypage_received')}>
                  <Text style={styles.seeAll}>전체 보기</Text>
                </TouchableOpacity>
              </View>

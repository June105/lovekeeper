...
const headerImage = require("../assets/images/logo-alert.png");
      ...
      <View style={styles.body}>
        <View style={styles.appNotice}>
          <Text style={styles.whiteColor}>
            [Notice] 러브키퍼 최신 버전이 출시됐어요! 지금 바로 앱스토어에서
            확인해보세요
          </Text>
        </View>
        <ScrollView style={styles.scrollArea}>
          <TouchableOpacity
            style={styles.newNotice}
            activeOpacity={0.7}
            onPress={() => navigation.navigate("Forbidden")}
          >
            <Text style={{ fontSize: 16 }}>
              <Text style={styles.whiteColor}>미미</Text>님이 화해 요청을
              보냈습니다.
            </Text>
            <Text style={{ color: "#393939", fontSize: 14 }}>2초 전</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.notice} activeOpacity={0.7}>
            <Text style={{ fontSize: 16 }}>
              <Text style={styles.empColor}>미미</Text>님이 화해 요청을
              보냈습니다.
            </Text>
            <Text style={{ color: "#393939", fontSize: 14 }}>2초 전</Text>
          </TouchableOpacity>

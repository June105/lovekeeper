...
const headerImage = require('../assets/images/logo-받은편지함.png');
...
export default function Mypage_received({navigation}) {
  return (
    <SafeAreaProvider initialMetrics={initialWindowMetrics} style={styles.container}>
          ...
          <View style={styles.head}>
            ...
            <Image source={settingIcon} style={{width: 24, height: 24, tintColor: 'transparent'}}></Image> 
          </View>
